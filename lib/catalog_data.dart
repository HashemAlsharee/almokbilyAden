...
final List<CompanyCatalog> companyCatalogs = [
  CompanyCatalog(
    ...
    productOverlayLogoPath: 'images/longi_logo.png',
    ...
    products: [
      ...
      ProductItem(
        ...
        imagePath: 'images/candian.png',
        description:
            'لوح شمسي ثنائي الوجه من سلسلة Hi-MO 9 يعتمد تقنية BC Cell لزيادة إنتاج الطاقة وتحسين الكفاءة. يوفر أداءً مستقراً للمشاريع التجارية ومحطات الطاقة مع موثوقية عالية وعمر تشغيلي طويل.',
        specifications: {
          'القدرة': '750 W',
          'الجهد': '49.20 V',
          'الكفاءة': '24.14 %',
          'الوزن': '37.3 kg',
          'نوع الخلايا': 'BC Cell',
          'الضمان': '12 سنة ضمان المنتج / 30 سنة ضمان القدرة',
        },
        datasheetPath: 'datasheet/LONGi Datasheet LR9-66HYD 730-760M EN.pdf',
      ),
    ],
  ),
  CompanyCatalog(
    ...
    productOverlayLogoPath: 'images/candiansolar_logo.png',
  ...
  CompanyCatalog(
    ...
    productOverlayLogoPath: 'images/solis_logo.png',
  ...
  CompanyCatalog(
    ...
    logoPath: 'images/PYLONTECH_banner_2170x725.webp',
    productOverlayLogoPath: 'images/PylonTech_logo.png',
  ...
  CompanyCatalog(
    ...
    productOverlayLogoPath: 'images/hithium_logo.png',
